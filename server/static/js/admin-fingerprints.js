...
(function () {
  ...
  function buildSection() {
    return `
      <details id="sec-fingerprints" class="group glass-effect rounded-2xl p-6 transition-all duration-300 hover:border-slate-500 border border-transparent lg:col-span-2 scroll-mt-24" ${isOpen("sec-fingerprints") ? "open" : ""}>
