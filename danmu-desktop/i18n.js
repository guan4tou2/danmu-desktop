...
const _resources = {
    "en": {
      ...
      "firstrunFieldHelp": "Supports ws:// or wss:// · LAN or public · default WebSocket port 4001",
      ...
      "overlayCardHint": "Toggle anytime with ⌘⇧D",
      "overlayActionStart": "▶ Start receiving",
      "overlayActionStop": "■ Stop receiving",
      ...
      "connBtnEdit": "Edit",
      "connBtnClose": "Close",
      "connTlsTitle": "Local · no TLS",
      "connTlsNote": "LAN doesn't need TLS · public should use wss://",
      "connTlsTitleWss": "TLS · encrypted",
      "connTlsNoteWss": "Public uses wss:// · certificate provided by server",
    ...
    "zh": {
      ...
      "firstrunStepReady": "READY",
      "firstrunFieldLabel": "SERVER · IP / HOST",
      "firstrunFieldHelp": "支援 ws:// 或 wss:// · 區網或公網皆可 · 預設 WebSocket port 4001",
      ...
      "overlayActionStart": "▶ 開始接收",
      "overlayActionStop": "■ 停止接收",
      ...
      "connBtnEdit": "更改",
      "connBtnClose": "關閉",
      "connTlsTitle": "本機 · 無 TLS",
      "connTlsNote": "區網連線不需 TLS · 公網建議 wss://",
      "connTlsTitleWss": "TLS · 已加密",
      "connTlsNoteWss": "公網連線使用 wss:// · 憑證由伺服器端提供",
    ...
    "ja": {
      ...
      "firstrunStepReady": "READY",
      "firstrunFieldLabel": "SERVER · IP / HOST",
      "firstrunFieldHelp": "ws:// または wss:// 対応 · LAN/公網どちらも · 既定 WebSocket port 4001",
      ...
      "overlayCardHint": "⌘⇧D でいつでも切替",
      "overlayActionStart": "▶ 受信開始",
      "overlayActionStop": "■ 受信停止",
      ...
      "connBtnEdit": "変更",
      "connBtnClose": "閉じる",
      "connTlsTitle": "ローカル · TLSなし",
      "connTlsNote": "LAN は TLS 不要 · 公開時は wss:// 推奨",
      "connTlsTitleWss": "TLS · 暗号化済み",
      "connTlsNoteWss": "公開接続は wss:// · 証明書はサーバー側が提供",
    ...
    "ko": {
      ...
      "firstrunStepReady": "READY",
      "firstrunFieldLabel": "SERVER · IP / HOST",
      "firstrunFieldHelp": "ws:// 또는 wss:// 지원 · LAN / 공용 · 기본 WebSocket port 4001",
      ...
      "overlayCardHint": "⌘⇧D 로 언제든 전환",
      "overlayActionStart": "▶ 수신 시작",
      "overlayActionStop": "■ 수신 중지",
      ...
      "connBtnEdit": "변경",
      "connBtnClose": "닫기",
      "connTlsTitle": "로컬 · TLS 없음",
      "connTlsNote": "LAN은 TLS 불필요 · 공개 시 wss:// 권장",
      "connTlsTitleWss": "TLS · 암호화됨",
      "connTlsNoteWss": "공개 연결은 wss:// · 인증서는 서버에서 제공",
