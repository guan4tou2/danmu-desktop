...
const _resources = {
    "en": {
      ...
      "firstrunFieldHelp": "Uses wss://HOST:PORT/ws · same port as web (default 443)",
      ...
      "overlaySectionTitle": "Overlay Control",
      "overlaySectionKicker": "Transparent · Click-through",
      "overlayCardTitle": "Danmu Overlay",
      "overlayCardHint": "Use ⌘⇧D anytime to toggle",
      ...
      "connTestHint": "Test: one-shot WSS handshake validation — does not spawn overlay or keep a connection.",
    ...
    "zh": {
      ...
      "firstrunStepReady": "READY",
      "firstrunFieldLabel": "SERVER · IP / HOST",
      "firstrunFieldHelp": "使用 wss://HOST:PORT/ws · 與 Web 同 port（預設 443）",
      ...
      "overlaySectionTitle": "Overlay 控制",
      "overlaySectionKicker": "透明層 · 點擊穿透",
      "overlayCardTitle": "彈幕 Overlay",
      "overlayCardHint": "任何時候可用 ⌘⇧D 快速切換",
      ...
      "connTestBtn": "⚐ 測試",
      "connTestChipIdle": "LAST TEST · —",
      "connTestHint": "測試：one-shot WSS handshake 驗證，不觸發 overlay、不留 connection",
      "connAuthSummary": "WebSocket Token",
      "connAuthKicker": "OPTIONAL · WSS HANDSHAKE",
    ...
    "ja": {
      ...
      "firstrunStepReady": "READY",
      "firstrunFieldLabel": "SERVER · IP / HOST",
      "firstrunFieldHelp": "wss://HOST:PORT/ws を使用 · Web と同 port（既定 443）",
      ...
      "overlaySectionTitle": "Overlay 制御",
      "overlaySectionKicker": "透明レイヤー · クリック透過",
      "overlayCardTitle": "弾幕 Overlay",
      "overlayCardHint": "いつでも ⌘⇧D で切り替え可能",
      ...
      "connTestBtn": "⚐ テスト",
      "connTestChipIdle": "LAST TEST · —",
      "connTestHint": "テスト: one-shot WSS ハンドシェイク検証 · overlay は起動せず、接続も保持しません。",
      "connAuthSummary": "WebSocket Token",
      "connAuthKicker": "OPTIONAL · WSS HANDSHAKE",
    ...
    "ko": {
      ...
      "firstrunStepReady": "READY",
      "firstrunFieldLabel": "SERVER · IP / HOST",
      "firstrunFieldHelp": "wss://HOST:PORT/ws 사용 · Web 과 동일 port (기본 443)",
      ...
      "overlaySectionTitle": "Overlay 제어",
      "overlaySectionKicker": "투명 레이어 · 클릭 투과",
      "overlayCardTitle": "댄무 Overlay",
      "overlayCardHint": "언제든 ⌘⇧D 로 전환 가능",
      ...
      "connTestBtn": "⚐ 테스트",
      "connTestChipIdle": "LAST TEST · —",
      "connTestHint": "테스트: one-shot WSS 핸드셰이크 검증 · 오버레이 실행 안 함, 연결 유지 안 함.",
      "connAuthSummary": "WebSocket Token",
      "connAuthKicker": "OPTIONAL · WSS HANDSHAKE",
