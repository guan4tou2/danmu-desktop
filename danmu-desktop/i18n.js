...
const _resources = {
    "en": {
      ...
      "connTestHint": "Verifies the server connection without starting Desktop",
    ...
    "zh": {
      ...
      "connTestBtn": "⚐ 測試",
      "connTestChipIdle": "LAST TEST · —",
      "connTestHint": "驗證伺服器連線，不會啟動 Desktop",
      "connAuthSummary": "WebSocket Token",
      "connAuthKicker": "OPTIONAL · WSS HANDSHAKE",
    ...
    "ja": {
      ...
      "connTestBtn": "⚐ テスト",
      "connTestChipIdle": "LAST TEST · —",
      "connTestHint": "サーバー接続を確認します。Desktopは起動しません",
      "connAuthSummary": "WebSocket Token",
      "connAuthKicker": "OPTIONAL · WSS HANDSHAKE",
    ...
    "ko": {
      ...
      "connTestBtn": "⚐ 테스트",
      "connTestChipIdle": "LAST TEST · —",
      "connTestHint": "서버 연결을 확인합니다. Desktop은 실행되지 않습니다",
      "connAuthSummary": "WebSocket Token",
      "connAuthKicker": "OPTIONAL · WSS HANDSHAKE",
