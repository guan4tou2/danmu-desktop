...
TRUSTED_HOSTS=localhost,127.0.0.1${domain:+,$domain}${server_ip:+,$server_ip}${server_domain:+,$server_domain}
TRUST_X_FORWARDED_FOR=$( [ "$_PROFILE" = "http" ] && echo "false" || echo "true" )
CORS_ORIGINS=*
