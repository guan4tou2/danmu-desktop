...
function _F480({ route, title, en, badge, back, children, hideTopbar }) {
  return (
    <div style={{
      width: 480, height: 900, background: hudTokens.bg0, color: hudTokens.text,
      fontFamily: hudTokens.fontSans, position: 'relative',
      display: 'flex', flexDirection: 'column', overflow: 'hidden',
      borderRadius: 28, boxShadow: '0 4px 16px rgba(0,0,0,0.3)',
    }}>
      {/* notch placeholder */}
      <div style={{
        height: 36, background: hudTokens.bg0, flexShrink: 0,
        display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 22px',
        fontFamily: hudTokens.fontMono, fontSize: 12, color: hudTokens.text, letterSpacing: 0.4,
      }}>
        <span>14:02</span>
        <span style={{
          width: 100, height: 22, borderRadius: 12, background: '#000',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          fontFamily: hudTokens.fontMono, fontSize: 8, color: hudTokens.lime, letterSpacing: 1.2,
        }}>● LIVE 02:42</span>
      ...
      {!hideTopbar && (
        <div style={{
          padding: '10px 16px', borderBottom: `1px solid ${hudTokens.line}`,
          background: hudTokens.bg1,
          ...
          {back ? (
            <span style={{
              ...
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontFamily: hudTokens.fontMono, fontSize: 14, color: hudTokens.cyan,
            }}>‹</span>
          ) : (
            <span style={{
              width: 28, height: 28, border: `1px solid ${hudTokens.line}`, borderRadius: 4,
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontFamily: hudTokens.fontMono, fontSize: 13, color: hudTokens.text,
            }}>☰</span>
          )}
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontFamily: hudTokens.fontMono, fontSize: 8.5, color: hudTokens.cyan, letterSpacing: 1.4 }}>{en}</div>
            <div style={{ fontSize: 14, fontWeight: 600, color: hudTokens.text, marginTop: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{title}</div>
          </div>
          {badge && (
            <span style={{
              fontFamily: hudTokens.fontMono, fontSize: 9, color: hudTokens.lime, letterSpacing: 1,
      ...
      <span style={{
        ...
        fontFamily: hudTokens.fontMono, fontSize: 8, color: hudTokens.textMute, letterSpacing: 1.3,
        padding: '2px 5px', background: hudTokens.bg0, border: `1px solid ${hudTokens.line}`, borderRadius: 2,
      }}>480 · {route}</span>
    ...
    <_F480 route="#/dashboard" title="控制台" en="DASHBOARD · LIVE">
      <div style={{ padding: 12, display: 'flex', flexDirection: 'column', gap: 10, height: '100%', overflow: 'auto' }}>
        ...
        <div style={{
          ...
          <span style={{ width: 7, height: 7, borderRadius: '50%', background: hudTokens.lime, boxShadow: `0 0 6px ${hudTokens.lime}`, flexShrink: 0 }} />
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontFamily: hudTokens.fontMono, fontSize: 8.5, color: hudTokens.cyan, letterSpacing: 1.1 }}>SESSION · keynote</div>
            <div style={{ fontSize: 11, color: hudTokens.text, marginTop: 1 }}>02:42:18 · 1,287 訊息</div>
          </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
          {[
            ...
            <div key={i} style={{
              ...
              <div style={{ fontFamily: hudTokens.fontMono, fontSize: 8.5, color: hudTokens.textMute, letterSpacing: 1.1 }}>{k.l.toUpperCase()}</div>
              <div style={{
              ...
              <div style={{ fontFamily: hudTokens.fontMono, fontSize: 8.5, color: hudTokens.textDim, marginTop: 3 }}>{k.d}</div>
            </div>
          ))}
        </div>

        {/* density chart */}
        <div style={{ background: hudTokens.bg1, border: `1px solid ${hudTokens.line}`, borderRadius: 4, padding: 10 }}>
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: 8 }}>
            <span style={{ fontFamily: hudTokens.fontMono, fontSize: 9, color: hudTokens.textDim, letterSpacing: 1.1 }}>密度 · 30 分鐘</span>
            <span style={{ marginLeft: 'auto', fontFamily: hudTokens.fontMono, fontSize: 8.5, color: hudTokens.textMute }}>peak 86</span>
          </div>
        ...
        <div style={{ background: hudTokens.bg1, border: `1px solid ${hudTokens.line}`, borderRadius: 4, padding: '10px 12px' }}>
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <span style={{ fontFamily: hudTokens.fontMono, fontSize: 9, color: hudTokens.textDim, letterSpacing: 1.1 }}>最近操作 · 8</span>
            <span style={{ marginLeft: 'auto', fontFamily: hudTokens.fontMono, fontSize: 12, color: hudTokens.cyan }}>›</span>
          </div>
          <div style={{ marginTop: 8, fontSize: 11, color: hudTokens.text, lineHeight: 1.4 }}>
            <span style={{ fontFamily: hudTokens.fontMono, fontSize: 9.5, color: hudTokens.textMute, marginRight: 6 }}>14:01:52</span>
            隱藏訊息 fp_88c1
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: 6, marginTop: 'auto' }}>
          {[
            ...
            <span key={i} style={{
              ...
              background: hudTokens.bg1,
              border: `1px solid ${a.tone === 'amber' ? 'rgba(251,191,36,0.45)' : a.tone === 'cyan' ? hudTokens.cyanLine : hudTokens.line}`,
              color: a.tone === 'amber' ? hudTokens.amber : a.tone === 'cyan' ? hudTokens.cyan : hudTokens.textDim,
              fontFamily: hudTokens.fontMono, fontSize: 10, letterSpacing: 0.6, fontWeight: 600,
    ...
    <_F480 route="#/messages" title="訊息審核" en="MESSAGES · 1,287">
      <div style={{ padding: 12, display: 'flex', flexDirection: 'column', gap: 10, height: '100%' }}>
        ...
        <div style={{ display: 'flex', gap: 6 }}>
          <div style={{ flex: 1, padding: '8px 12px', background: hudTokens.bg1, border: `1px solid ${hudTokens.line}`, borderRadius: 4 }}>
            <span style={{ fontFamily: hudTokens.fontMono, fontSize: 11, color: hudTokens.textMute, letterSpacing: 0.3 }}>⌕ 搜尋…</span>
          </div>
          <span style={{
            padding: '8px 12px', background: hudTokens.bg1, border: `1px solid ${hudTokens.line}`, borderRadius: 4,
            display: 'inline-flex', alignItems: 'center', gap: 5,
            fontFamily: hudTokens.fontMono, fontSize: 11, color: hudTokens.text,
          }}>
            <span>⊟</span>
            <span style={{ padding: '0 4px', background: hudTokens.cyan, color: hudTokens.bg0, borderRadius: 2, fontSize: 9, fontWeight: 700 }}>3</span>
          </span>
        </div>
        ...
        <div style={{ flex: 1, minHeight: 0, background: hudTokens.bg1, border: `1px solid ${hudTokens.line}`, borderRadius: 4, overflow: 'auto' }}>
          {[
            ...
            <div key={i} style={{
              padding: '9px 12px', borderBottom: i < arr.length - 1 ? `1px solid ${hudTokens.line}` : 'none',
              display: 'flex', flexDirection: 'column', gap: 3,
            }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                <span style={{ fontSize: 11.5, color: hudTokens.text, fontWeight: 500 }}>{r.n}</span>
                <_Tag480 tone={r.c} mono sm>{r.s}</_Tag480>
                <span style={{ marginLeft: 'auto', fontFamily: hudTokens.fontMono, fontSize: 9, color: hudTokens.textMute }}>{r.t}</span>
              </div>
              <div style={{
                fontSize: 12, color: r.s === 'SHOWN' ? hudTokens.text : hudTokens.textDim,
        ...
        <div style={{
          fontFamily: hudTokens.fontMono, fontSize: 9, color: hudTokens.textMute, letterSpacing: 0.6,
    ...
    <_F480 route="#/polls/poll_47fa" title="下一個 demo 看哪一個?" en="POLL · DETAIL · LIVE" back>
      <div style={{ padding: 12, display: 'flex', flexDirection: 'column', gap: 10, height: '100%', overflow: 'auto' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          <span style={{ fontFamily: hudTokens.fontMono, fontSize: 9, color: hudTokens.textDim, letterSpacing: 1, marginLeft: 'auto' }}>poll_47fa · 02:14 / 05:00</span>
        </div>

        {/* editable title */}
        <div style={{ background: hudTokens.bg1, border: `1px solid ${hudTokens.line}`, borderRadius: 4, padding: 12 }}>
          <div style={{ fontFamily: hudTokens.fontMono, fontSize: 8.5, color: hudTokens.textMute, letterSpacing: 1.1, marginBottom: 6 }}>標題</div>
          <div style={{ fontSize: 15, fontWeight: 600, color: hudTokens.text, lineHeight: 1.3 }}>下一個 demo 看哪一個?</div>
        </div>

        {/* options live results */}
        <div style={{ background: hudTokens.bg1, border: `1px solid ${hudTokens.line}`, borderRadius: 4, padding: 12 }}>
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: 10 }}>
            <span style={{ fontFamily: hudTokens.fontMono, fontSize: 9, color: hudTokens.textDim, letterSpacing: 1.1 }}>選項 · 4</span>
            <span style={{ marginLeft: 'auto', fontFamily: hudTokens.fontMono, fontSize: 9, color: hudTokens.cyan, letterSpacing: 0.5 }}>即時 · 76 票</span>
          </div>
            ...
            {[
              ...
              <div key={i}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
                  <span style={{ fontSize: 12, color: hudTokens.text, fontWeight: o.lead ? 600 : 400 }}>{o.l}</span>
                ...
                <div style={{ height: 5, background: hudTokens.bg2, borderRadius: 3, overflow: 'hidden' }}>
                  <div style={{ width: `${o.p}%`, height: '100%', background: o.lead ? hudTokens.cyan : hudTokens.cyanLine, borderRadius: 3 }} />
                </div>
              </div>
            ))}
          </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
          {[
            ...
            <div key={i} style={{ background: hudTokens.bg1, border: `1px solid ${hudTokens.line}`, borderRadius: 4, padding: 10 }}>
              <div style={{ fontFamily: hudTokens.fontMono, fontSize: 8.5, color: hudTokens.textMute, letterSpacing: 1.1 }}>{m.l.toUpperCase()}</div>
              <div style={{ fontFamily: '"Zen Kaku Gothic New", sans-serif', fontSize: 20, fontWeight: 700, marginTop: 3, color: m.tone === 'cyan' ? hudTokens.cyan : hudTokens.lime, letterSpacing: -0.3, lineHeight: 1 }}>{m.v}</div>
            </div>
          ))}
        </div>
        ...
        <div style={{ marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: 6 }}>
          <span style={{
            ...
            fontFamily: hudTokens.fontMono, fontSize: 12, letterSpacing: 1, fontWeight: 700,
          }}>結束投票 · 顯示結果</span>
      ...
      <div style={{ padding: 12, display: 'flex', flexDirection: 'column', gap: 12, height: '100%', overflow: 'auto' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ width: 10, height: 10, borderRadius: '50%', background: hudTokens.lime }} />
          </div>
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontFamily: hudTokens.fontMono, fontSize: 9, color: hudTokens.lime, letterSpacing: 1.3 }}>CURRENT</div>
            <div style={{ fontSize: 18, fontWeight: 700, color: hudTokens.text, marginTop: 2, letterSpacing: -0.3 }}>LIVE · 顯示中</div>
            <div style={{ fontFamily: hudTokens.fontMono, fontSize: 9, color: hudTokens.textDim, marginTop: 2, letterSpacing: 0.3 }}>queue: 0 · 02:42:18</div>
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6 }}>
          {[
            ...
            <span key={i} style={{
              ...
              <span style={{ fontSize: 8.5, color: hudTokens.textMute, letterSpacing: 1.2 }}>{b.k}</span>
        ...
        {/* metrics 2×2 */}
        <div style={{ background: hudTokens.bg1, border: `1px solid ${hudTokens.line}`, borderRadius: 4, padding: 12 }}>
          <div style={{ fontFamily: hudTokens.fontMono, fontSize: 9, color: hudTokens.textDim, letterSpacing: 1.1, marginBottom: 10 }}>METRICS</div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
            {[
              ...
              <div key={i}>
                <div style={{ fontFamily: hudTokens.fontMono, fontSize: 8.5, color: hudTokens.textMute, letterSpacing: 1 }}>{m.l.toUpperCase()}</div>
                <div style={{ fontFamily: '"Zen Kaku Gothic New", sans-serif', fontSize: 18, fontWeight: 700, color: hudTokens.text, marginTop: 3, lineHeight: 1, letterSpacing: -0.3 }}>{m.v}</div>
                {m.s && <div style={{ fontFamily: hudTokens.fontMono, fontSize: 8.5, color: hudTokens.textDim, marginTop: 2, letterSpacing: 0.3 }}>{m.s}</div>}
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{
          ...
          fontSize: 10, color: hudTokens.text, lineHeight: 1.55, letterSpacing: 0.2,
        }}>
          <span style={{ fontFamily: hudTokens.fontMono, color: hudTokens.cyan, letterSpacing: 1.1 }}>STANDBY 提醒</span> · 暫停顯示時觀眾仍可送訊息進 queue。
        </div>
      </div>
    </_F480>
  );
      ...
      <div style={{ padding: 12, display: 'flex', flexDirection: 'column', gap: 12, height: '100%', overflow: 'auto' }}>
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontFamily: hudTokens.fontMono, fontSize: 9, color: hudTokens.textDim, marginTop: 6, letterSpacing: 0.4 }}>14:01:38 · 40 秒前</div>
          </div>
        </div>

        {/* details */}
        <div style={{ background: hudTokens.bg1, border: `1px solid ${hudTokens.line}`, borderRadius: 4, padding: 12 }}>
          <div style={{ fontFamily: hudTokens.fontMono, fontSize: 9, color: hudTokens.textDim, letterSpacing: 1.1, marginBottom: 8 }}>事件摘要</div>
          <div style={{ fontSize: 11.5, color: hudTokens.text, lineHeight: 1.6 }}>
            IP <code style={{ fontFamily: hudTokens.fontMono, color: hudTokens.amber }}>192.168.5.12</code> 在 <b>8 秒</b> 內送出 <b>23 則訊息</b>,系統已自動冷卻 5 分鐘。指紋連續匹配 3 場次 — 建議檢視來源並考慮永久封禁。
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6, marginTop: 12 }}>
            {[
              ...
              <div key={i} style={{ background: hudTokens.bg2, borderRadius: 3, padding: '6px 8px' }}>
                <div style={{ fontFamily: hudTokens.fontMono, fontSize: 8.5, color: hudTokens.textMute, letterSpacing: 1 }}>{m.l.toUpperCase()}</div>
                <div style={{ fontFamily: hudTokens.fontMono, fontSize: 11, color: hudTokens.text, marginTop: 2, letterSpacing: 0.3 }}>{m.v}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: 6 }}>
          <span style={{
            padding: '12px 14px', borderRadius: 3, textAlign: 'center',
            background: hudTokens.crimson, color: hudTokens.bg0,
            fontFamily: hudTokens.fontMono, fontSize: 12, letterSpacing: 1, fontWeight: 700,
          }}>永久封禁 IP</span>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6 }}>
            <span style={{
            ...
            <span style={{
              padding: '9px 10px', borderRadius: 3, textAlign: 'center',
              background: hudTokens.bg2, color: hudTokens.textDim, border: `1px solid ${hudTokens.line}`,
              fontFamily: hudTokens.fontMono, fontSize: 10, letterSpacing: 0.5,
            }}>標記已讀</span>
          </div>
        </div>
          ...
          {[
            ...
            <div key={i} style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                ...
                <span style={{ fontSize: 12, color: hudTokens.text, fontWeight: 600, flex: 1, minWidth: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{s.t}</span>
              </div>
              <div style={{ fontFamily: hudTokens.fontMono, fontSize: 9, color: hudTokens.textDim, letterSpacing: 0.3 }}>{s.d}</div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                <span style={{ fontSize: 10.5, color: hudTokens.text }}>{s.m}</span>
                <span style={{ marginLeft: 'auto', fontFamily: hudTokens.fontMono, fontSize: 9, color: s.s === 'OPEN' ? hudTokens.lime : hudTokens.textDim, letterSpacing: 0.4 }}>{s.ms}</span>
                <span style={{ fontFamily: hudTokens.fontMono, fontSize: 11, color: hudTokens.cyan }}>›</span>
              </div>
            </div>
          ))}
        </div>
