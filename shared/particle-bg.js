 ...
 *   Consumed by:
 *     - danmu-desktop/renderer-modules/particle-bg.js  (symlink, webpack-bundled)
 *     - server/static/js/particle-bg.js                (symlink, plain <script>)
 *
 * Dual-mode export:
 *   - CommonJS:  const { initParticleBg } = require("./particle-bg");
 *   - Browser:   <script src="…/particle-bg.js">  →  window.initParticleBg(...)
 *
...
(function (root, factory) {
  ...
  if (typeof window !== "undefined") {
    window.initParticleBg = api.initParticleBg;
  }
